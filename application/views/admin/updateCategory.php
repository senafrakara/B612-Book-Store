<div class="my-form">
    ...
    <?= form_open("admin/editCategory/{$catDetail->id}")?>
        <div class="form-group row">
            <label for="category-name" class="col-sm-2 col-form-label">Category Name</label>
            <div class="col-sm-6">
            <?= form_input(['name'=>'category', 'value'=>set_value('category', $catDetail->category), 'placeholder'=> 'Category name...', 'class'=>'form-control'])?>
            </div>
            <div class="col-md-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
            <?= form_textarea(['name'=>'description', 'placeholder'=>'Category description...','value'=>set_value('description', $catDetail->description), 'class'=>'form-control','rows'=>'5',])?>
            </div>
            <div class="col-md-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
            <?= form_input(['name'=>'tag', 'value'=>set_value('tag', $catDetail->tag), 'placeholder'=> 'Category tag...', 'class'=>'form-control'])?>
            </div>
            <div class="col-md-4">
