<div class="container">
    <div class="my-form">
        ...
        <?= form_open_multipart("admin/editBook/{$book_detail->id}") ?>
            ...
            <div class="col-sm-6">
                <select name="categoryId" class="form-control">
                    ...
                    <?php foreach ($category as $cat) : ?>
                        ...
                        <?php
                        if ($book_detail->categoryId == $cat->id) {
                            print '<option value="' . $book_detail->categoryId . '" selected>' . $cat->category . ' </option>';
                        } else {
