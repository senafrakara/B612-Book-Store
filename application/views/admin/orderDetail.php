...
<div class="clearfix">
        ...
        <tr>
            ...
            <td class="text-left">
                ...
                if ($orderDetail->status == 1) {
                    ...
                    print  '<p class = "text-success">Accepted</p>';
                } else {
                  
                    print  '<p class = "text-success">Pending</p>';
                }
    ...
    <?php if ($orderDetail->status == 0) : ?>
        <a href="<?= base_url('admin/acceptOrder/' . $orderDetail->orderId . '') ?>" title="Edit" class="btn btn-success btn-sm"> <i class="fas fa-check"></i> Accept Order</a>&nbsp
        <a href="<?= base_url('admin/deleteOrder/' . $orderDetail->orderId . '') ?>" title="Delete" class="btn btn-danger btn-sm delete" data-confirm="Are you sure to cencel this order?"> <i class="fas fa-trash"></i> Cancle Order</a>&nbsp
    <?php else : ?>
        <a href="<?= base_url('admin/deleteOrder/' . $orderDetail->orderId . '') ?>" title="Delete" class="btn btn-danger btn-sm delete" data-confirm="Are you sure to cencel this order?"> <i class="fas fa-trash"></i> Cancle Order</a>&nbsp
